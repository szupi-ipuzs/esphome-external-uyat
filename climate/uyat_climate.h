...
class UyatClimate : public climate::Climate, public Component {
 public:
  ...
  void set_switch_id(const MatchingDatapoint& switch_id) { this->switch_id_ = switch_id; }
  ...
  void set_target_temperature_id(const MatchingDatapoint& target_temperature_id) {
    this->target_temperature_id_ = target_temperature_id;
  }
  void set_current_temperature_id(const MatchingDatapoint& current_temperature_id) {
  ...
  void set_eco_id(const MatchingDatapoint& eco_id) { this->eco_id_ = eco_id; }
  void set_eco_temperature(float eco_temperature) { this->eco_temperature_ = eco_temperature; }
  void set_sleep_id(const MatchingDatapoint& sleep_id) { this->sleep_id_ = sleep_id; }
 ...
 protected:
  ...
  bool supports_heat_;
  bool supports_cool_;
  optional<MatchingDatapoint> switch_id_{};
  ...
  optional<MatchingDatapoint> target_temperature_id_{};
  optional<MatchingDatapoint> current_temperature_id_{};
  float current_temperature_multiplier_{1.0f};
  float target_temperature_multiplier_{1.0f};
  float hysteresis_{1.0f};
  optional<MatchingDatapoint> eco_id_{};
  optional<MatchingDatapoint> sleep_id_{};
